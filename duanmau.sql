...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 21, 2024 at 12:39 PM
...
(2, 'Nguyen Huu Huy', 'Nam', '2004-12-27', 'Ha Noi - Dan Phuong - Viet Nam', 1),
...
(1, 'huymamicoi@gmail.com', 'huyme27', 'huylove123', b'1', 'users/user-default.png'),
(2, 'huymixao@gmail.com', 'huy', '123456', b'0', 'users/user-default.png'),
(59, 'thaihoangofficial@gmail.com', 'thaihoang91', 'thoicom123', b'0', 'users/th.jpg'),
(72, 'hiepttph46123@fpt.edu.vn', 'hiep', 'hiep123', b'0', 'users/user-default.png'),
(73, 'quannmph46036@fpt.edu.vn', 'quan', 'quan123', b'0', 'users/user-default.png'),
(74, 'huynhph46090@fpt.edu.vn', 'huy123123', 'huylove123456', b'0', 'users/user-default.png'),
...
--
ALTER TABLE `chi_tiet_don_hang`
  ADD CONSTRAINT `FK_chitietdonhang_donhang` FOREIGN KEY (`maDonHang`) REFERENCES `don_hang` (`maDonHang`),
  ADD CONSTRAINT `FK_chitietdonhang_sanpham` FOREIGN KEY (`maSanPham`) REFERENCES `san_pham` (`maSanPham`);
